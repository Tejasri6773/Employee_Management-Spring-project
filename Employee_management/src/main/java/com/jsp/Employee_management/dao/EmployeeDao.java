...
//	}
	...
	public EmployeeDetails findByEmail(String email) {
		EmployeeDetails r = repo.findByEmail(email);
	        if (r!=null) {
	            return r;
	        } else {
	            return null;
...
//		return null;
//	}
	public EmployeeDetails empFetch(String email) {
		return repo.findByEmail(email);
	}
   
    
    public Optional<EmployeeDetails> empFetchById(int id) {
    	return repo.findById(id);
    }
    public EmployeeDetails empFetchByPwd(String pwd) {
    	return repo.fetchByPwd(pwd);
    }
    public EmployeeDetails empFetchByEmailPwd(String email,String pwd) {
    	return repo.findByEmailPwd(email, pwd);
    }
